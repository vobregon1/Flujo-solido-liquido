...
def cuadro_variables(titulo, filas):
    """Muestra un cuadro blanco con variables, significado y unidades."""
    
    filas_html = ""

    for variable, significado, unidades in filas:
        filas_html += (
            "<tr>"
            f"<td class='var-simbolo'>{variable}</td>"
            f"<td>{significado}</td>"
            f"<td>{unidades}</td>"
            "</tr>"
        )
...
Seccion = st.segmented_control(
    ...
    ["Ecuaciones", "Cálculos", "Visualización", "Simulación"],
    default="Ecuaciones"
)
...
with st.sidebar:
    if Seccion == "Ecuaciones":
        ...
        st.markdown(
            """
            <p style='font-size: 14px; color: black;'>
            En esta sección se incluye el acceso al simulador visual de los regímenes de flujo
            en suspensiones sólido-líquido dentro de tuberías horizontales.
            </p>
            """,
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            """
            <p style='font-size: 14px; color: black;'>
            El simulador permite observar de forma gráfica los regímenes:
            homogéneo, heterogéneo y saltación.
            </p>
            """,
            unsafe_allow_html=True
        )
...
if Seccion == "Ecuaciones":
    ...
    cuadro_variables(
        ...
        [
            ("W<sub>p</sub>", "Velocidad de separación o sedimentación de la partícula.", "m/s"),
            ("W<sub>t</sub>", "Velocidad turbulenta o velocidad típica de mezcla del fluido.", "m/s"),
        ]
    )
    ...
    cuadro_variables(
        ...
        [
            ("W<sub>p</sub>", "Velocidad de separación o sedimentación de la partícula.", "m/s"),
            ("W<sub>t</sub>", "Velocidad turbulenta o velocidad típica de mezcla del fluido.", "m/s"),
            ("K", "Constante crítica de suspensión.", "Adimensional"),
        ]
    )
    ...
    with c1:
        ...
        cuadro_variables(
            ...
            [
                ...
                ("ν<sub>C</sub>", "Viscosidad cinemática del fluido continuo.", "m²/s"),
                ("Δρ", "Diferencia de densidad entre el sólido y el fluido continuo.", "kg/m³"),
                ("ρ<sub>C</sub>", "Densidad del fluido continuo.", "kg/m³"),
            ]
        )
    ...
    with c2:
        ...
        cuadro_variables(
            ...
            [
                ...
                ("R", "Radio de la partícula.", "m"),
                ("g", "Aceleración de la gravedad.", "m/s²"),
                ("C<sub>D</sub>", "Coeficiente de arrastre de la partícula.", "Adimensional"),
                ("Δρ", "Diferencia de densidad entre el sólido y el fluido continuo.", "kg/m³"),
                ("ρ<sub>C</sub>", "Densidad del fluido continuo.", "kg/m³"),
            ]
        )
    ...
    cuadro_variables(
        ...
        [
            ("W<sub>t</sub>", "Velocidad turbulenta o velocidad típica de mezcla del fluido.", "m/s"),
            ("τ<sub>w</sub>", "Esfuerzo cortante en la pared de la tubería.", "Pa"),
            ("ρ<sub>C</sub>", "Densidad del fluido continuo.", "kg/m³"),
            ("d", "Diámetro interno de la tubería.", "m"),
            ("−dp/ds", "Gradiente de presión en la dirección del flujo.", "Pa/m"),
        ]
    )
    ...
    cuadro_variables(
        "Variables y unidades",
        [
            ("j<sub>c</sub>", "Velocidad superficial crítica.", "m/s"),
            ("K", "Constante crítica de suspensión.", "Adimensional"),
            ("C<sub>D</sub>", "Coeficiente de arrastre de la partícula.", "Adimensional"),
            ("g", "Aceleración de la gravedad.", "m/s²"),
            ("R", "Radio de la partícula.", "m"),
...
# Sección 4: Simulación
    ...
    st.subheader("Simulación visual de regímenes de flujo")

    st.markdown(
        """
        En esta sección se puede acceder a una simulación interactiva que permite observar
        de forma visual el comportamiento de una suspensión sólido-líquido en una tubería horizontal.
        """
    )

    st.markdown(
        """
        La simulación muestra los tres regímenes principales estudiados en este tema:
        **flujo homogéneo**, **flujo heterogéneo** y **flujo con saltación**.
        """
    )

    st.info(
        "Esta herramienta sirve como apoyo visual para comprender cómo se distribuyen "
        "las partículas dentro de la tubería según la intensidad del flujo."
    )

    st.link_button(
        "Abrir simulación interactiva",
        "https://simulaciones-mf-azbxq2oebntzzh5sefdpu3.streamlit.app/"
    )
